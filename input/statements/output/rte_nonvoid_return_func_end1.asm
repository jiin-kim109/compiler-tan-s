        ...
        LoadI                                  
        StoreI                                 
        Label        -while-5-continueTarget   
        Label        -while-5-condition        
        ...
        StoreI                                 
        CallV                                  
        Label        -syracuse-7-call-end      
        Label        -syracuse-7-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -syracuse-7-returnHandshake-end 
        Nop                                    
        StoreI                                 
        Jump         -while-5-condition        
        Label        -while-5-breakTarget      
        Label        -while-5-end              
        PushD        $FP                       
        LoadI                                  
        PushI        -12                       
        ...
        Label        -while-8-body             
        Label        -callStatement-11-start   
        Label        -sequence-10-call-start   
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% sequence
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -sequence-10-call-end     
        Label        -sequence-10-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -sequence-10-returnHandshake-end 
        Pop                                    
        Label        -callStatement-11-end     
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% count
        PushD        $global-memory-block      
