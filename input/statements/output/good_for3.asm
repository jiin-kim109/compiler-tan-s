        ...
        PushD        $print-format-character   
        Printf                                 
        Label        -for-3-continueTarget     
        Label        -for-3-increment          
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% j
        Duplicate                              
        ...
        Add                                    
        StoreI                                 
        Jump         -for-3-condition          
        Label        -for-3-breakTarget        
        Label        -for-3-end                
        PushI        10                        
        PushD        $print-format-character   
        Printf                                 
