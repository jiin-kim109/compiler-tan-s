        ...
        StoreI                                 
        CallV                                  
        Label        -mod-7-call-end           
        Label        -mod-7-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -mod-7-returnHandshake-end 
        Nop                                    
        ...
        StoreI                                 
        CallV                                  
        Label        -mod-9-call-end           
        Label        -mod-9-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -mod-9-returnHandshake-end 
        Nop                                    
        ...
        PushI        8                         
        Add                                    %% sequence
        PushD        -function-13-start        
        StoreI                                 
        Jump         -function-13-bypass       
        Label        -function-13-start        
        Nop                                    %% start: store return address at SP + -8
        PushD        $SP                       
        LoadI                                  
        PushI        -8                        
        ...
        StoreI                                 
        Nop                                    %% end: SP -= frameSize
        Label        -function-13-callHandshake-end 
        Label        -function-13-userCode-start 
        PushI        10                        
        ...
        StoreI                                 
        CallV                                  
        Label        -syrup-16-call-end        
        Label        -syrup-16-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -syrup-16-returnHandshake-end 
        Nop                                    
        StoreI                                 
        ...
        PushD        $print-format-character   
        Printf                                 
        Jump         -function-13-returnTarget 
        Label        -function-13-userCode-end 
        Label        -function-13-returnTarget 
        PushD        $FP                       
        LoadI                                  
        PushI        -8                        
        Add                                    
        ...
        Pop                                    
        Return                                 
        Label        -function-13-returnHandshake-end 
        Halt                                   
        Label        -function-13-end          
        Label        -function-13-bypass       
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% min
        PushI        90                        
        ...
        JumpFalse    -while-17-end             
        Label        -while-17-body            
        Label        -callStatement-20-start   
        Label        -sequence-19-call-start   
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% sequence
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -sequence-19-call-end     
        Label        -sequence-19-returnHandshake-start 
        Label        -sequence-19-returnHandshake-end 
        Label        -callStatement-20-end     
        PushD        $global-memory-block      
        PushI        20                        
        Add                                    %% count
        PushD        $global-memory-block      
        ...
        Label        -while-17-breakTarget     
        Label        -while-17-end             
        DLabel       -stringConstant-21--start 
