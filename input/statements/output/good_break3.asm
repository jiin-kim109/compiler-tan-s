        ...
        Label        -if-5-branch              
        JumpFalse    -if-5-false               
        Jump         -while-2-breakTarget      
        Jump         -if-5-end                 
        Label        -if-5-false               
        Label        -if-5-end                 
        PushD        $FP                       
        ...
        Label        -while-6-body             
        Label        -callStatement-9-start    
        Label        -sequence-8-call-start    
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% sequence
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -sequence-8-call-end      
        Label        -sequence-8-returnHandshake-start 
        Label        -sequence-8-returnHandshake-end 
        Label        -callStatement-9-end      
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% count
        PushD        $global-memory-block      
