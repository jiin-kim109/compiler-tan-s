        ...
        PushI        4                         
        Add                                    %% sequence
        PushD        -function-8-start         
        StoreI                                 
        Jump         -function-8-bypass        
        ...
        StoreI                                 
        Nop                                    %% end: SP -= frameSize
        Label        -function-8-callHandshake-end 
        Label        -function-8-userCode-start 
        PushI        10                        
        ...
        JumpFalse    -while-9-end              
        Label        -while-9-body             
        PushD        $FP                       
        LoadI                                  
        PushI        -12                       
        Add                                    %% num
        Label        -syrup-11-call-start      
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% syrup
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -syrup-11-call-end        
        Label        -syrup-11-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -syrup-11-returnHandshake-end 
        Nop                                    
        StoreI                                 
        ...
        PushD        $print-format-character   
        Printf                                 
        Jump         -function-8-returnTarget  
        Label        -function-8-userCode-end  
        Label        -function-8-returnTarget  
        PushD        $FP                       
        LoadI                                  
        PushI        -8                        
        Add                                    
        ...
        Pop                                    
        Return                                 
        Label        -function-8-returnHandshake-end 
        Halt                                   
        Label        -function-8-end           
        Label        -function-8-bypass        
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% min
        PushI        12                        
        ...
        LoadI                                  
        StoreI                                 
        Label        -while-16-continueTarget  
        Label        -while-16-condition       
        Label        -compare-17-args-start    
        ...
        JumpFalse    -while-16-end             
        Label        -while-16-body            
        Label        -callStatement-19-start   
        Label        -sequence-18-call-start   
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% sequence
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -sequence-18-call-end     
        Label        -sequence-18-returnHandshake-start 
        Label        -sequence-18-returnHandshake-end 
        Label        -callStatement-19-end     
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% count
        PushD        $global-memory-block      
