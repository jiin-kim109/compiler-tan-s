        ...
        PushD        $record-create-temp       
        LoadI                                  
        DLabel       -stringConstant-10--start 
        DataI        3                         type id for string
        DataI        9                         status for string
        DataI        2                         length
        DataC        103                       %% "gh"
        ...
        JumpFalse    -while-15-end             
        Label        -while-15-body            
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% result
        Label        -holler-17-call-start     
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% holler
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -holler-17-call-end       
        Label        -holler-17-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -holler-17-returnHandshake-end 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% result
        ...
        StoreI                                 
        CallV                                  
        Label        -isOdd-18-call-end        
        Label        -isOdd-18-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadC                                  
        PushI        1                         
        ...
        Exchange                               
        StoreI                                 
        Label        -isOdd-18-returnHandshake-end 
        ...
        PushD        $print-format-character   
        Printf                                 
        DLabel       -stringConstant-20--start 
        DataI        3                         type id for string
        DataI        9                         status for string
        DataI        9                         length
        DataC        97                        %% "all done."
