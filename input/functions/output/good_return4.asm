        ...
        PushD        $print-format-character   
        Printf                                 
        Label        -booleanNegate-5-args-start 
        Label        -booleanNegate-5-arg1     
        Label        -isOdd-4-call-start       
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% isOdd
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -isOdd-4-call-end         
        Label        -isOdd-4-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadC                                  
        PushI        1                         
        ...
        Exchange                               
        StoreI                                 
        Label        -isOdd-4-returnHandshake-end 
        Nop                                    
        Label        -booleanNegate-5-start    
        BNegate                                
        Duplicate                              
        JumpFalse    -booleanNegate-5-end      
        Pop                                    
        PushI        1                         
        Label        -booleanNegate-5-end      
        ...
        PushI        4                         
        Add                                    %% isOdd
        PushD        -function-6-start         
        StoreI                                 
        Jump         -function-6-bypass        
        Label        -function-6-start         
        Nop                                    %% start: store return address at SP + -8
        PushD        $SP                       
        LoadI                                  
        PushI        -8                        
        ...
        StoreI                                 
        Nop                                    %% end: SP -= frameSize
        Label        -function-6-callHandshake-end 
        Label        -function-6-userCode-start 
        ...
        Jump         -function-6-returnTarget  
        Label        -function-6-userCode-end  
        Jump         $$l-no-return-from-lambda 
        Label        -function-6-returnTarget  
        PushD        $FP                       
        LoadI                                  
        PushI        -8                        
        Add                                    
        ...
        StoreC                                 
        Return                                 
        Label        -function-6-returnHandshake-end 
        Halt                                   
        Label        -function-6-end           
        Label        -function-6-bypass        
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% max
        PushI        6                         
        ...
        PushI        0                         
        StoreI                                 
        Label        -while-8-continueTarget   
        Label        -while-8-condition        
        ...
        JumpFalse    -while-8-end              
        Label        -while-8-body             
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% result
        Label        -holler-10-call-start     
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% holler
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -holler-10-call-end       
        Label        -holler-10-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadC                                  
        PushI        1                         
        ...
        Exchange                               
        StoreI                                 
        Label        -holler-10-returnHandshake-end 
        StoreC                                 
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% result
        ...
        Nop                                    
        StoreI                                 
        Jump         -while-8-condition        
        Label        -while-8-breakTarget      
        Label        -while-8-end              
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% max
        ...
        StoreI                                 
        CallV                                  
        Label        -isOdd-12-call-end        
        Label        -isOdd-12-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadC                                  
        PushI        1                         
        ...
        Exchange                               
        StoreI                                 
        Label        -isOdd-12-returnHandshake-end 
        ...
        PushD        $print-format-character   
        Printf                                 
        DLabel       -stringConstant-14--start 
