        ...
        StoreI                                 
        CallV                                  
        Label        -pax-7-call-end           
        Label        -pax-7-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -pax-7-returnHandshake-end 
        Nop                                    
        Add                                    
        Jump         -function-1-returnTarget  
        ...
        StoreI                                 
        CallV                                  
        Label        -pax-8-call-end           
        Label        -pax-8-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -pax-8-returnHandshake-end 
        PushD        $print-format-integer     
        Printf                                 
        PushI        10                        
        PushD        $print-format-character   
