        ...
        Subtract                               
        Nop                                    
        Label        -intToCharCast-4-start    
        PushI        127                       
        BTAnd                                  
        Label        -intToCharCast-4-end      
        ...
        StoreI                                 
        CallV                                  
        Label        -isOdd-10-call-end        
        Label        -isOdd-10-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadC                                  
        PushI        1                         
        ...
        Exchange                               
        StoreI                                 
        Label        -isOdd-10-returnHandshake-end 
