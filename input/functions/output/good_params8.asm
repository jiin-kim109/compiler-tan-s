        ...
        Label        -callStatement-3-start    
        Label        -holler-2-call-start      
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% holler
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -holler-2-call-end        
        Label        -holler-2-returnHandshake-start 
        Label        -holler-2-returnHandshake-end 
        Label        -callStatement-3-end      
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% m
        PushF        0.340000                  
