        ...
        StoreI                                 
        CallV                                  
        Label        -apply-16-call-end        
        Label        -apply-16-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -apply-16-returnHandshake-end 
        ...
        PushD        $print-format-character   
        Printf                                 
        DLabel       -stringConstant-18--start 
