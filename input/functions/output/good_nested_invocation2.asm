        ...
        StoreI                                 
        CallV                                  
        Label        -cow-11-call-end          
        Label        -cow-11-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -cow-11-returnHandshake-end 
        Nop                                    
        ...
        StoreI                                 
        CallV                                  
        Label        -cow-13-call-end          
        Label        -cow-13-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -cow-13-returnHandshake-end 
        ...
        StoreI                                 
        CallV                                  
        Label        -goat-15-call-end         
        Label        -goat-15-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadF                                  
        PushI        8                         
        ...
        Exchange                               
        StoreI                                 
        Label        -goat-15-returnHandshake-end 
        Nop                                    
        Nop                                    
        ConvertI                               
        PushI        -4                        
        ...
        StoreI                                 
        CallV                                  
        Label        -cow-16-call-end          
        Label        -cow-16-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -cow-16-returnHandshake-end 
        Nop                                    
        ...
        StoreI                                 
        CallV                                  
        Label        -cow-18-call-end          
        Label        -cow-18-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -cow-18-returnHandshake-end 
        Nop                                    
        ...
        StoreI                                 
        CallV                                  
        Label        -cow-20-call-end          
        Label        -cow-20-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -cow-20-returnHandshake-end 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% AA
        LoadI                                  
        Label        -arrayPrint-21-start      
        Duplicate                              
        JumpTrue     -arrayPrint-21-nonNull    
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-21-end        
        Label        -arrayPrint-21-nonNull    
        PushD        $array-start-string       
        PushD        $print-format-string      
        Printf                                 
        PushI        0                         
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-21-loopExit   
        Label        -arrayPrint-21-loop       
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-21-loopContinue 
        Jump         -arrayPrint-21-loopExit   
        Label        -arrayPrint-21-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-21-loop       
        Label        -arrayPrint-21-loopExit   
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-21-end        
        PushI        10                        
        PushD        $print-format-character   
        Printf                                 
        DLabel       -stringConstant-22--start 
