        ...
        StoreI                                 
        CallV                                  
        Label        -stomp-2-call-end         
        Label        -stomp-2-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -stomp-2-returnHandshake-end 
        PushD        $print-format-integer     
        Printf                                 
        PushI        10                        
        PushD        $print-format-character   
        ...
        Label        -callStatement-5-start    
        Label        -holler-4-call-start      
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% holler
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -holler-4-call-end        
        Label        -holler-4-returnHandshake-start 
        Label        -holler-4-returnHandshake-end 
        Label        -callStatement-5-end      
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% m
        PushF        0.340000                  
        StoreF                                 
        Label        -callStatement-7-start    
        Label        -holler-6-call-start      
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% holler
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -holler-6-call-end        
        Label        -holler-6-returnHandshake-start 
        Label        -holler-6-returnHandshake-end 
        Label        -callStatement-7-end      
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% m
        LoadF                                  
