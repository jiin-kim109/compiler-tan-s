        ...
        StoreI                                 
        CallV                                  
        Label        -holler-8-call-end        
        Label        -holler-8-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -holler-8-returnHandshake-end 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% result
        ...
        StoreI                                 
        CallV                                  
        Label        -isOdd-9-call-end         
        Label        -isOdd-9-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadC                                  
        PushI        1                         
        ...
        Exchange                               
        StoreI                                 
        Label        -isOdd-9-returnHandshake-end 
