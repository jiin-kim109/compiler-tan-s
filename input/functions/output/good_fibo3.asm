        ...
        Label        -printTwoPlaces-5-call-start 
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% printTwoPlaces
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -printTwoPlaces-5-call-end 
        Label        -printTwoPlaces-5-returnHandshake-start 
        Label        -printTwoPlaces-5-returnHandshake-end 
        ...
        PushI        8                         
        Add                                    %% fibonacciNumber
        PushD        -function-7-start         
        StoreI                                 
        Jump         -function-7-bypass        
        Label        -function-7-start         
        Nop                                    %% start: store return address at SP + -8
        PushD        $SP                       
        LoadI                                  
        PushI        -8                        
        ...
        StoreI                                 
        Nop                                    %% end: SP -= frameSize
        Label        -function-7-callHandshake-end 
        Label        -function-7-userCode-start 
        Label        -if-9-condition           
        ...
        Label        -if-9-branch              
        JumpFalse    -if-9-false               
        PushI        0                         
        Jump         -function-7-returnTarget  
        Jump         -if-9-end                 
        Label        -if-9-false               
        Label        -if-9-end                 
        ...
        Label        -if-11-false              
        Label        -if-11-end                
        Label        -fibonacciNumber-12-call-start 
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% fibonacciNumber
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -fibonacciNumber-12-call-end 
        Label        -fibonacciNumber-12-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -fibonacciNumber-12-returnHandshake-end 
        Nop                                    
        Label        -fibonacciNumber-13-call-start 
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% fibonacciNumber
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -fibonacciNumber-13-call-end 
        Label        -fibonacciNumber-13-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -fibonacciNumber-13-returnHandshake-end 
        Nop                                    
        Add                                    
        Jump         -function-7-returnTarget  
        Label        -function-7-userCode-end  
        Jump         $$l-no-return-from-lambda 
        Label        -function-7-returnTarget  
        PushD        $FP                       
        LoadI                                  
        PushI        -8                        
        Add                                    
        ...
        StoreI                                 
        Return                                 
        Label        -function-7-returnHandshake-end 
        Halt                                   
        Label        -function-7-end           
        Label        -function-7-bypass        
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% max
        PushI        20                        
        ...
        PushI        20                        
        Add                                    %% thisFib
        Label        -fibonacciNumber-16-call-start 
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% fibonacciNumber
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -fibonacciNumber-16-call-end 
        Label        -fibonacciNumber-16-returnHandshake-start 
        PushD        $SP                       
        LoadI                                  
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -fibonacciNumber-16-returnHandshake-end 
        StoreI                                 
        Label        -callStatement-18-start   
        Label        -printFiboLine-17-call-start 
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% printFiboLine
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -printFiboLine-17-call-end 
        Label        -printFiboLine-17-returnHandshake-start 
        Label        -printFiboLine-17-returnHandshake-end 
        Label        -callStatement-18-end     
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% n
        PushD        $global-memory-block      
