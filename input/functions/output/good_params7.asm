        ...
        PushI        0                         
        StoreI                                 
        Label        -while-3-continueTarget   
        Label        -while-3-condition        
        ...
        Nop                                    
        StoreI                                 
        Jump         -while-3-condition        
        Label        -while-3-breakTarget      
        Label        -while-3-end              
        ...
        StoreI                                 
        CallV                                  
        Label        -holler-7-call-end        
        Label        -holler-7-returnHandshake-start 
        Label        -holler-7-returnHandshake-end 
        ...
        Exchange                               
        StoreI                                 
        Label        -populatedArray-9-startChildren 
        PushD        $record-create-temp       
        LoadI                                  
        PushI        11                        
        Nop                                    
