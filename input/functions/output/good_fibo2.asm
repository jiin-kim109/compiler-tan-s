        ...
        PushI        1                         
        StoreI                                 
        Label        -callStatement-8-start    
        Label        -printFiboLine-7-call-start 
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% printFiboLine
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -printFiboLine-7-call-end 
        Label        -printFiboLine-7-returnHandshake-start 
        Label        -printFiboLine-7-returnHandshake-end 
        Label        -callStatement-8-end      
        Label        -callStatement-10-start   
        Label        -printFiboLine-9-call-start 
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% printFiboLine
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -printFiboLine-9-call-end 
        Label        -printFiboLine-9-returnHandshake-start 
        Label        -printFiboLine-9-returnHandshake-end 
        ...
        Nop                                    
        StoreI                                 
        Label        -callStatement-13-start   
        Label        -printFiboLine-12-call-start 
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% printFiboLine
        LoadI                                  
        ...
        StoreI                                 
        CallV                                  
        Label        -printFiboLine-12-call-end 
        Label        -printFiboLine-12-returnHandshake-start 
        Label        -printFiboLine-12-returnHandshake-end 
        Label        -callStatement-13-end     
        Label        -for-11-continueTarget    
        Label        -for-11-increment         
        PushD        $global-memory-block      
        PushI        20                        
        Add                                    %% n
        Duplicate                              
        ...
        Add                                    
        StoreI                                 
        Jump         -for-11-condition         
        Label        -for-11-breakTarget       
        Label        -for-11-end               
        Halt                                   
        Halt                                   
