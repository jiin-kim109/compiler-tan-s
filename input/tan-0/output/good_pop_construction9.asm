        ...
        Nop                                    
        StoreI                                 
        Jump         -while-loop-9-condition   
        Label        -while-loop-9-exit        
        Label        loop1-end                 
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% indx
        ...
        LoadC                                  
        Nop                                    
        JumpFalse    -and-24-false             
        PushD        $global-memory-block      
        PushI        9                         
        Add                                    %% elem2
        LoadC                                  
        Nop                                    
        JumpFalse    -and-23-false             
        PushD        $global-memory-block      
        PushI        10                        
        Add                                    %% elem3
        LoadC                                  
        ...
        Jump         -not-29-join              
        Label        -not-29-join              
        JumpFalse    -if-condition-30-false    
        Label        -if-condition-30-true     
        DLabel       string0                   
        DataI        3                         
        DataI        9                         
        DataI        4                         
        ...
        Nop                                    
        StoreI                                 
        Jump         -while-loop-32-condition  
        Label        -while-loop-32-exit       
        Label        loop2-end                 
        Halt                                   
