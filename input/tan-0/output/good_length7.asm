        ...
        PushD        arrayLengthexpressionList9 
        LoadI                                  
        Label        -arrayDefaultValueexpressionList11-6-loopStart 
        Duplicate                              
        JumpFalse    -arrayDefaultValueexpressionList11-6-loopEnd 
        PushI        1                         
        Subtract                               
        Duplicate                              
        PushI        4                         
        ...
        PushI        0                         
        StoreI                                 
        Jump         -arrayDefaultValueexpressionList11-6-loopStart 
        Label        -arrayDefaultValueexpressionList11-6-loopEnd 
        Pop                                    
        Duplicate                              
        PushI        16                        
        Add                                    
        ...
        PushD        arrayLengthexpressionList0 
        LoadI                                  
        Label        -arrayDefaultValueexpressionList2-3-loopStart 
        Duplicate                              
        JumpFalse    -arrayDefaultValueexpressionList2-3-loopEnd 
        PushI        1                         
        Subtract                               
        Duplicate                              
        PushI        4                         
        ...
        PushI        0                         
        StoreI                                 
        Jump         -arrayDefaultValueexpressionList2-3-loopStart 
        Label        -arrayDefaultValueexpressionList2-3-loopEnd 
        Pop                                    
        Duplicate                              
        PushI        16                        
        Add                                    
