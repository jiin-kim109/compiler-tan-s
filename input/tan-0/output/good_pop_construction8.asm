        ...
        LoadC                                  
        Nop                                    
        JumpFalse    -and-16-false             
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% elem5
        LoadC                                  
        Nop                                    
        JumpFalse    -and-15-false             
        PushD        $global-memory-block      
        PushI        13                        
        Add                                    %% elem6
        LoadC                                  
        Nop                                    
        JumpFalse    -and-14-false             
        PushD        $global-memory-block      
        PushI        14                        
        Add                                    %% elem7
        LoadC                                  
        ...
        JumpFalse    -if-condition-23-false    
        Label        -if-condition-23-true     
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% indx
        LoadI                                  
        ...
        Jump         -not-24-join              
        Label        -not-24-join              
        JumpFalse    -if-condition-25-false    
        Label        -if-condition-25-true     
        DLabel       string0                   
        DataI        3                         
        DataI        9                         
        DataI        4                         
        ...
        Nop                                    
        StoreI                                 
        Jump         -while-loop-27-condition  
        Label        -while-loop-27-exit       
        Label        loop1-end                 
        Halt                                   
