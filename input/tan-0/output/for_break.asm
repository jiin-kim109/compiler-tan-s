        ...
        PushI        5                         
        StoreI                                 
        Jump         -for-condition-4-condition 
        Label        loop0-start               
        Label        -for-condition-4-increment 
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% i
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Label        -for-condition-4-condition 
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% i
        LoadI                                  
        ...
        Printf                                 
        Jump         -for-condition-4-increment 
        Label        -for-condition-4-exit     
        Label        loop0-end                 
