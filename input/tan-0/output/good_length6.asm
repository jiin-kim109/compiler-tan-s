        ...
        PushD        arrayLengthexpressionList0 
        LoadI                                  
        Label        -arrayDefaultValueexpressionList2-2-loopStart 
        Duplicate                              
        JumpFalse    -arrayDefaultValueexpressionList2-2-loopEnd 
        PushI        1                         
        Subtract                               
        Duplicate                              
        PushI        4                         
        ...
        PushI        0                         
        StoreI                                 
        Jump         -arrayDefaultValueexpressionList2-2-loopStart 
        Label        -arrayDefaultValueexpressionList2-2-loopEnd 
        Pop                                    
        Duplicate                              
        PushI        16                        
        Add                                    
