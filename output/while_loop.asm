        ...
        Label        -while-condition-4-condition 
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% i
        LoadI                                  
        ...
        JumpFalse    -while-condition-4-false  
        Label        -while-condition-4-true   
        ...
        Nop                                    
        StoreI                                 
        Jump         -while-condition-4-condition 
        Label        -while-condition-4-false  
