        ...
        PushI        0                         
        StoreI                                 
        Label        -while-condition-3-condition 
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% counter
        LoadI                                  
        ...
        JumpFalse    -while-condition-3-false  
        Label        -while-condition-3-true   
        DLabel       string0                   
        DataI        3                         
        DataI        9                         
        DataI        4                         
        ...
        Add                                    
        StoreI                                 
        Jump         -while-condition-3-condition 
        Label        -while-condition-3-false  
        DLabel       string1                   
        DataI        3                         
        DataI        9                         
        DataI        5                         
