        ...
        PushI        5                         
        StoreI                                 
        Jump         -for-condition-2-condition 
        Label        loop0-start               
        Label        -for-condition-2-increment 
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% i
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Label        -for-condition-2-condition 
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% i
        LoadI                                  
        ...
        Printf                                 
        Jump         -for-condition-2-increment 
        Label        -for-condition-2-exit     
        Label        loop0-end                 
