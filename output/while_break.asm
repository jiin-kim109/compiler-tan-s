        ...
        PushI        2                         
        StoreI                                 
        Label        while-loop0-start         
        Label        -while-condition-6-condition 
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% i
        LoadI                                  
        ...
        JumpFalse    -while-condition-6-false  
        Label        -while-condition-6-true   
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% i
        LoadI                                  
        ...
        JumpFalse    -if-condition-3-false     
        Label        -if-condition-3-true      
        Jump         while-loop0-end           
        Label        -if-condition-3-false     
        ...
        Nop                                    
        StoreI                                 
        Jump         -while-condition-6-condition 
        Label        -while-condition-6-false  
        Label        while-loop0-end           
        Halt                                   
