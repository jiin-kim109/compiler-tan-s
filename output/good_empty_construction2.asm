        ...
        PushI        0                         
        StoreI                                 
        Label        -while-condition-5-condition 
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% indx
        LoadI                                  
        ...
        JumpFalse    -while-condition-5-false  
        Label        -while-condition-5-true   
        ...
        Add                                    
        StoreI                                 
        Jump         -while-condition-5-condition 
        Label        -while-condition-5-false  
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% indx
        PushI        0                         
        StoreI                                 
        Label        -while-condition-15-condition 
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% indx
        LoadI                                  
        ...
        JumpFalse    -while-condition-15-false 
        Label        -while-condition-15-true  
        ...
        Add                                    
        StoreI                                 
        Jump         -while-condition-15-condition 
        Label        -while-condition-15-false 
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% indx
        PushI        0                         
        StoreI                                 
        Label        -while-condition-38-condition 
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% indx
        LoadI                                  
        ...
        JumpFalse    -while-condition-38-false 
        Label        -while-condition-38-true  
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% elem1
        ...
        JumpFalse    -if-condition-34-false    
        Label        -if-condition-34-true     
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% indx
        LoadI                                  
        ...
        Jump         -not-35-join              
        Label        -not-35-join              
        JumpFalse    -if-condition-36-false    
        Label        -if-condition-36-true     
        DLabel       string0                   
        DataI        3                         
        DataI        9                         
        DataI        5                         
        ...
        Add                                    
        StoreI                                 
        Jump         -while-condition-38-condition 
        Label        -while-condition-38-false 
        Halt                                   
