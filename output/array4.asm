        ...
        PushD        arrayLengthexpressionList6 
        LoadI                                  
        Label        -arrayDefaultValueexpressionList8-6-loopStart 
        Duplicate                              
        JumpFalse    -arrayDefaultValueexpressionList8-6-loopEnd 
        PushI        1                         
        Subtract                               
        Duplicate                              
        PushI        4                         
        ...
        PushI        0                         
        StoreI                                 
        Jump         -arrayDefaultValueexpressionList8-6-loopStart 
        Label        -arrayDefaultValueexpressionList8-6-loopEnd 
        Pop                                    
        StoreI                                 
